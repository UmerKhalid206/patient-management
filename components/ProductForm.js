...
export default function ProductForm({
  ...
  const [specialization,setspecialization] = useState(existingSpecialization || '');
  const [fees,setFees] = useState(existingFees || '');
  ...
  async function saveProduct(ev) {
    ...
    if (_id) {
      //update
      // console.log('update id ha', _id)
      await axios.put('/api/doctor/register', {...data,_id});
    } else {
      //create
